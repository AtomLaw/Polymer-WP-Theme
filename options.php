 ...
 *
 * If you are making your theme translatable, you should replace 'allthetheme'
...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => __('Header Meta', 'allthetheme'),
		'type' => 'heading');

// Standard Meta
	$options[] = array(
		'name' => __('Head ID', 'allthetheme'),
		'desc' => __("", 'allthetheme'),
		'id' => 'meta_headid',
		'std' => 'allthetheme',
		'type' => 'text');
	$options[] = array(
		'name' => __('Google Webmasters', 'allthetheme'),
		'desc' => __("Speaking of Google, don't forget to set your site up: <a href='http://google.com/webmasters' target='_blank'>http://google.com/webmasters</a>", 'allthetheme'),
		'id' => 'meta_google',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('Author Name', 'allthetheme'),
		'desc' => __('Populates meta author tag.', 'allthetheme'),
		'id' => 'meta_author',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('Mobile Viewport', 'allthetheme'),
		'desc' => __('Uncomment to use; use thoughtfully!', 'allthetheme'),
		'id' => 'meta_viewport',
...
// Icons
	$options[] = array(
		'name' => __('Site Favicon', 'allthetheme'),
		'desc' => __('', 'allthetheme'),
		'id' => 'head_favicon',
		'type' => 'upload');
	$options[] = array(
		'name' => __('Apple Touch Icon', 'allthetheme'),
		'desc' => __('', 'allthetheme'),
...
// App: Windows 8
	$options[] = array(
		'name' => __('App: Windows 8', 'allthetheme'),
		'desc' => __('Application Name', 'allthetheme'),
		'id' => 'meta_app_win_name',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'allthetheme'),
		'desc' => __('Tile Color', 'allthetheme'),
		'id' => 'meta_app_win_color',
		'std' => '',
		'type' => 'color');
	$options[] = array(
		'name' => __('', 'allthetheme'),
		'desc' => __('Tile Image', 'allthetheme'),
...
// App: Twitter
	$options[] = array(
		'name' => __('App: Twitter Card', 'allthetheme'),
		'desc' => __('twitter:card (summary, photo, gallery, product, app, player)', 'allthetheme'),
		'id' => 'meta_app_twt_card',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'allthetheme'),
		'desc' => __('twitter:site (@username of website)', 'allthetheme'),
		'id' => 'meta_app_twt_site',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'allthetheme'),
		'desc' => __("twitter:title (the user's Twitter ID)", 'allthetheme'),
		'id' => 'meta_app_twt_title',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'allthetheme'),
		'desc' => __('twitter:description (maximum 200 characters)', 'allthetheme'),
		'id' => 'meta_app_twt_description',
		'std' => '',
		'type' => 'textarea');
	$options[] = array(
		'name' => __('', 'allthetheme'),
		'desc' => __('twitter:url (url for the content)', 'allthetheme'),
		'id' => 'meta_app_twt_url',
		'std' => '',
		'type' => 'text');
...
// App: Facebook
	$options[] = array(
		'name' => __('App: Facebook', 'allthetheme'),
		'desc' => __('og:title', 'allthetheme'),
		'id' => 'meta_app_fb_title',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'allthetheme'),
		'desc' => __('og:description', 'allthetheme'),
		'id' => 'meta_app_fb_description',
		'std' => '',
		'type' => 'textarea');
	$options[] = array(
		'name' => __('', 'allthetheme'),
		'desc' => __('og:url', 'allthetheme'),
		'id' => 'meta_app_fb_url',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'allthetheme'),
		'desc' => __('og:image', 'allthetheme'),
