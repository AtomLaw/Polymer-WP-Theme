...
<head id="<?php echo of_get_option('meta_headid'); ?>" data-template-set="allthetheme-wordpress-theme">
	...
	?>
		...
		<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/static/css/combined.css">
